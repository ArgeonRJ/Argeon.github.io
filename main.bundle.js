...
var FichaComponent = /** @class */ (function () {
    ...
    FichaComponent.prototype.criarFichas = function () {
        var _this = this;
        if (this.userId == null) {
            this.showToast();
        }
            ...
            setTimeout(function () {
                _this.router.navigateByUrl('/criar_ficha');
            }, 100);
        }
    };
